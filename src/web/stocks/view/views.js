...
function show_top10_result(table_array){
    ...
    var table = "<table id='empresa_table' class='table table-bordered table-condensed'>" 
                + "<thead><tr bgcolor='#f5f5f5'><td colspan='3' style='text-align:center;font-weight:bold'>Ranking de " + metric + " por " + grouping + "</td></tr><tr bgcolor='#f5f5f5'><th>Ranking</th><th align='center'>" 
