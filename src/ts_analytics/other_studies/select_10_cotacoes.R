...
emp.selecionadas.nome.pregao <- c("MARCOPOLO", "GAFISA", "COTEMINAS", "AMBEV", "BRASIL", "VALE", "PETROBRAS", 
"TELEBRAS", "OI", "ELETROBRAS")

emp.small <- subset(emp, nome_pregao %in% emp.selecionadas.nome.pregao, c("nome_pregao", "cnpj"))
